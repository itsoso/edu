...
def dashboard_summary():
    ...
    with db() as conn:
        ...
        # 今日训练: 本周生成的训练题集, 统计 item 总数 / 已做 / 正确数
...
@app.post("/api/reports/monthly/<month>/generate")
@login_required
...
@app.delete("/api/reports/monthly/<month>")
@login_required
